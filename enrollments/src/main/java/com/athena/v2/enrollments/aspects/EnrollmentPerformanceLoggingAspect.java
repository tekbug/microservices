...
import com.athena.v2.enrollments.repositories.CoursesPerformanceLogsRepository;
...
@Component
@Slf4j
public class EnrollmentPerformanceLoggingAspect {

    private final CoursesPerformanceLogsRepository performanceLogsRepository;
    private final HttpServletRequest httpServletRequest;
    private final IdGeneratorForLogsService idGenerator;

    public EnrollmentPerformanceLoggingAspect(CoursesPerformanceLogsRepository performanceLogsRepository,
    ...
    public Object logPerformance(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        EnrollmentPerformanceLogs performanceLogs = new EnrollmentPerformanceLogs();
        ...
        try {
            ...
            performanceLogs.setAction(null);
            performanceLogs.setOperationType(null);
