...
import com.athena.v2.students.repositories.StudentsPerformanceLogsRepository;
...
import static com.athena.v2.students.aspects.StudentActivityLoggingAspect.getActionType;
...
public class StudentPerformanceLoggingAspect {
    ...
    private final StudentsPerformanceLogsRepository performanceLogsRepository;
    private final HttpServletRequest httpServletRequest;
    private final IdGeneratorForLogsService idGenerator;

    public StudentPerformanceLoggingAspect(StudentsPerformanceLogsRepository performanceLogsRepository,
    ...
    public Object logPerformance(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        StudentsPerformanceLogs performanceLogs = new StudentsPerformanceLogs();
